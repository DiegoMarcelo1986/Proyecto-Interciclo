...
<html>
    ...
    <body>
        ...
        <form atributes action="modificarU.php?cedula=<?php echo $row["cedula"];?>" method="post" enctype="multipart/form-data">       
            ...
            <div>
                ...
                <input type="button" id="Regresar" name="regresar" value="Home" onclick="location.href = 'homeCli.php';" style="width: 101px; margin-left: 25px" required/>
            </div>                                                           
