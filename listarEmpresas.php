...
<html class="c">
    ...
    <body enctype="multipart/form-data">
        ...
        <div method="post">
            ...
            <table>
                <caption><h3>EMPRESAS</h3></caption>
                <thead>
                    <tr>
                        <th>CODIGO</th>
                        <th>IMAGEN</th>
                        ...
                        <th>DIRECCION</th>
                        <th>TELEFONO</th>
                        <th><a href="crearEmpresa.php"><img src="css/agregar.png" height="50px"></a></th>
                        <th><a href="buscarEmpresa.php"><img src="css/lupa.png" height="50px"></a></th>
                    ...
                    <?php
                        ...
                        if($result->num_rows > 0){
                            ...
                            while($row=$result->fetch_assoc()){
                              ...
                              echo "<td>".'<img  height="40px" src="data:image/jpeg;base64,'.base64_encode($row['emp_img']) .' "/>'."</td>";
                              echo " <td> <a href='listarSucursal.php?emp_cod=" . $row['emp_cod'] . "'>SUCURSAL</a> </td>";
                              echo " <td> <a href='modificarEmpresa.php?emp_cod=" . $row['emp_cod'] . "'>Modificar</a> </td>";
